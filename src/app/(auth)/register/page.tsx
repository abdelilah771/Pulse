            ...
            <div className="relative hidden h-full flex-col bg-slate-900 p-10 text-white lg:flex justify-between">
                ...
                <div className="relative z-20">
                    <blockquote className="space-y-2">
                        <p className="text-lg">
                            &ldquo;Rejoignez une communauté d'apprenants et structurez votre progression quotidienne avec des outils adaptés.&rdquo;
                        </p>
                ...
                <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
                    <div className="flex flex-col space-y-2 text-center">
                        ...
                        <p className="text-sm text-slate-500">
                            Entrez votre email pour organiser votre vie.
                        </p>
                    </div>
